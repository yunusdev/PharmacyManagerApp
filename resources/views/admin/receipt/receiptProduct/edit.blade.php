                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit the Receipt {{$rProduct->invoice_no}}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="{{route('receiptProduct.update', $rProduct->id)}}">
                            {{csrf_field()}}
                            {{method_field('PATCH')}}
                            ...
                            <div class="box-body">
                                <div class="col-lg-6 col-lg-offset-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" value="{{$rProduct->quantity}}" name="quantity" id="quantity" placeholder="Enter quantity" required>
                                    </div>
                                    <div class="form-group">
